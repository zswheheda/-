      ...
      <div class="container" style="padding-left: 0px; padding-right: 0px;">
        <div class="navbar-header">
	     ...
	     <div role="navigation" class="navbar-collapse collapse">
	     		<a id="_logo"  href="http://127.0.0.1：8080/shiro.demo/" style="color:#fff; font-size: 24px;" class="navbar-brand hidden-sm">权限控制 演示</a>
				...
				<li class="dropdown " style="color:#fff;">
					...
					<shiro:user>  
						...
						<ul class="dropdown-menu" userid="<shiro:principal property="id"/>">
							<li><a href="http://127.0.0.1:8080/shiro.demo/user/index.shtml">个人资料</a></li>
							<li><a href="http://127.0.0.1:8080/shiro.demo/role/mypermission.shtml">我的权限</a></li>
